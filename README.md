...
**Experimental pre-release: 0.2.5-rc.1**
...
> **v0.2.5-rc.1 rule:** the Gen 1 target map defines every coordinate and gameplay meaning. FireRed supplies only visual cells, including selected evidence-based landmark cells; the original Gen 1 semantic tile remains locked for each of the block’s four movement cells.
